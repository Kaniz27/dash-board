...
export default function Header() {
  return (
    <div className="w-full h-20 bg-white shadow-sm flex items-center justify-between px-6 fixed top-0 z-50">
      ...
      <div className="flex items-center gap-4 flex-1 ml-6 justify-end">
        ...
        <FiBell size={20} className="text-gray-500 hover:text-violet-600 cursor-pointer" />
        <FiSettings size={20} className="text-gray-500 hover:text-violet-600 cursor-pointer" />
